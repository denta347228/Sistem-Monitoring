...
<head>
    ...
    <title>Pengolahan Data Survey</title>
    <!-- Bootstrap Styles-->
                                                        ...
                                                        <?php 
                                                         ...
                                                         ?>
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td>                                                                         <center><a  href="edit_data_survey.php?id_survey=<?php echo $data1['id_survey']; ?>" class="btn btn-primary" id="full" role="button">Update</a></center>
                                                                    </td>
                                                                </tr>
                                                        <?php
                                                                $i++; 
