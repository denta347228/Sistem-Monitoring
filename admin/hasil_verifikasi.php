                ...
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="hasil_verifikasi.php"class="active-menu"><i class="fa fa-table"></i> Data Verifikasi</a>
                            </li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div style="padding-bottom: 10px;">
                                        ...
                                        <a class="btn btn-warning" href="export_hasil_verifikasi_valid.php" target="_blank" role="button">
