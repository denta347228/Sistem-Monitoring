            ...
            <div class="sidebar-collapse">
               <ul class="nav" id="main-menu">
                   ...
                   <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="data_sales.php" class="active-menu"><i class="fa fa-table"></i> Data Sales </a>
                            </li>
                            <li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div style="padding-bottom: 10px;">
                                        ...
                                        <a class="btn btn-warning" href="export_data_sales.php" target="_blank" role="button">
