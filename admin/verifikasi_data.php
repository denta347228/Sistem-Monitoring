<?php 
    ...
    $selected_id_sales=$_GET['id_sales'];

    $sql2="SELECT * FROM data_sales JOIN data_survey JOIN user ON data_sales.id_sales = data_survey.id_sales AND data_sales.id_salesforce=id_user WHERE data_sales.id_sales='$selected_id_sales'";
    $result2=mysqli_query($koneksi,$sql2);
    $data1=mysqli_fetch_array($result2);

    $sql3="SELECT username FROM data_sales JOIN data_survey JOIN teknisi JOIN user ON data_sales.id_sales = data_survey.id_sales AND teknisi.id_teknisi=data_survey.id_teknisi AND teknisi.id_user=user.id_user WHERE data_sales.id_sales='$selected_id_sales'";
...
<head>
    ...
    <title>Verifikasi Data Sales <?php echo $selected_id_sales; ?></title>
    <!-- Bootstrap Styles-->
            ...
            <div class="sidebar-collapse">
               <ul class="nav" id="main-menu">
                    <li>
                     ...
                     <li>
                        <a href="data_verifikasi.php"  class="active-menu" ><i class="fa fa-edit"></i>Verifikasi Data</a>
                    </li>
             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                             <b>VERIFIKASI DATA SALES </b><small><?php echo $selected_id_sales ?></small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                                    ...
                                                                    <tr class="even gradeC">
                                                                        <td><b>Teknisi : </b><?php echo $data3['username']; ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="data_verifikasi.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Masukan Keterangan" name="keterangan"required autocomplete="off">
                                        </div>
                                        <button type="submit" name="validasi" class="btn btn-danger" value="<?php echo $selected_id_sales; ?>">Tambah</button>
                                        <button type="reset" class="btn btn-success">Reset</button>
                                        <a class="btn btn-primary" href="data_verifikasi.php" role="button">Kembali</a>
                                    </form>
                                </div>
