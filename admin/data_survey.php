        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
               <ul class="nav" id="main-menu">
                   ...
                   <li>
                        <a href="" class="active-menu"><i class="fa fa-table"></i> Tampil Data <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="data_sales.php" ><i class="fa fa-table"></i> Data Sales </a>
                            </li>
                            <li>
                                <a href="data_survey.php" class="active-menu"><i class="fa fa-table"></i> Data Survey </a>
                            </li>
                            <li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div style="padding-bottom: 10px;">
                                        ...
                                        <a class="btn btn-warning" href="export_data_survey.php" target="_blank" role="button">
                                                         ...
                                                         ?>
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td> 
                                                                        ...
                                                                        <button type="button" class="btn btn-danger" id="full" data-toggle="modal" data-target="#<?php echo $i; ?>">
                                                                          Show
                                                                        </button>
