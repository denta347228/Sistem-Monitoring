<?php 
    ...
    $sql1="SELECT data_sales.*, user.*, assignment_update FROM data_sales JOIN user JOIN data_survey ON id_salesforce=id_user AND data_sales.id_sales=data_survey.id_sales WHERE status_survei=1 AND status_verifikasi=0";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Daftar Data Sales yang belum diverifikasi : 
                        </div>
                                ...
                                <div class="col-md-12">
                                    <?php if (isset($success)) { ?>
                                        <div class="alert alert-success alert-dismissible" >
                                            ...
                                            <b>Data anda berhasil diverifikasi</b>
                                        </div>
                                    <?php } ?>
                                    <?php if (isset($eror2)){ ?>
                                        <div class="alert alert-warning alert-dismissible" >
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                            <h4><i class="icon fa fa-warning"></i> Data gagal diverifikasi !</h4>
                                            <b>Data anda sudah pernah diverifikasi</b>
                                        </div>
                                    <?php } ?>
                                    <?php if (isset($eror3)){ ?>
                                        <div class="alert alert-warning alert-dismissible" >
                                                        ...
                                                        <?php 
                                                         ...
                                                         ?>
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td> 
                                                                        <a href="verifikasi_data.php?id_sales=<?php echo $data1['id_sales']; ?>" class="btn btn-primary" id="full">Pilih</a>
                                                                    </td>
                                                                </tr>
                                                        <?php
                                                                $i++; 
