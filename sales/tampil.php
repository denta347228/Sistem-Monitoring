<?php 
    ...
    $sql1="SELECT * FROM data_sales JOIN user ON id_salesforce=id_user WHERE id_salesforce ='$id_sales'";
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <a href="index.php" ><i class="fa fa-edit"></i> Input Data Sales </a>
                    </li>
                    <li>
                        <a href="tampil.php" class="active-menu"><i class="fa fa-table"></i> Data Sales</a>
                    </li>
                </ul>
                                                                    ...
                                                                    <td>
                                                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                                            ...
                                                                            <tr class="even gradeX">
                                                                                <?php if($data1['status_survei'] == '0'){  ?>
                                                                                        <td><b>Assgin Date : </b>-</td>
                                                                                <?php 
                                                                                    } else{  
                                                                                        $id=$data1['id_sales'];
                                                                                        $sql="SELECT assignment_update FROM data_survey WHERE id_sales ='$id'";
                                                                                        $result=mysqli_query($koneksi,$sql);
                                                                                        $data=mysqli_fetch_array($result);
                                                                                ?>
                                                                                        <td><b>Assgin Date : </b> </b><?php echo $data['assignment_update']; ?></td></td>
                                                                                <?php } ?>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
