<?php 
    ...
    $sql1="SELECT data_sales.*, user.*, assignment_update FROM data_sales JOIN user JOIN data_survey ON id_salesforce=id_user AND data_sales.id_sales=data_survey.id_sales WHERE status_survei=99";
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <a href="index.php"><i class="fa fa-edit"></i> Assign Data Sales</a>
                    </li>
                    <li>
                        <a href="data_assign.php" class="active-menu"><i class="fa fa-table"></i>Hasil Assign Data Sales</a>
                    </li>
                </ul>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Daftar Data Sales yang sudah diassign
                        </div>
                                                                    ...
                                                                    <td>
                                                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                                            ...
                                                                            <tr class="even gradeX">
                                                                                <td><b>Assgin Date : </b><?php echo $data1['assignment_update']; ?></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
